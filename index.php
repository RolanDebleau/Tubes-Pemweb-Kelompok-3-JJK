...
?>
    ...
    <div class="home-container">
        ...
        <div class="hero-artwork-frame">
            <img class="artwork-bg" src="img/subtract.svg" alt="" aria-hidden="true" />
            <img class="artwork-character" id="hero-char-img" src="img/group-6.png" alt="Jujutsu character artwork" />
        </div>
